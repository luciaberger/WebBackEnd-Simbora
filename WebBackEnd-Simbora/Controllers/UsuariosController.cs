...
namespace WebBackEnd_Simbora.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        [HttpPost]
        [AllowAnonymous]
        public async Task<IActionResult> Login([Bind("CPF, Senha")] Usuario usuario)
        {
        ...
        public async Task<IActionResult> Create([Bind("CPF,Nome,Telefone,email,Senha,Perfil")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CPF,Nome,Telefone,email,Senha,Perfil")] Usuario usuario)
        {
            if (id != usuario.CPF)
            {
                return NotFound();
